...
public static class RobotEventTypes
{
    ...
    private static readonly HashSet<string> _allEvents = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "ENGINE_TICK_STALL_DETECTED", "ENGINE_TICK_STALL_RECOVERED", "ENGINE_TICK_CALLSITE", "ENGINE_TIMER_HEARTBEAT",
        ...
        // Health monitoring
        "CONNECTION_LOST", "CONNECTION_LOST_SUSTAINED", "CONNECTION_RECOVERED", "CONNECTION_RECOVERED_NOTIFICATION", "CONNECTION_CONFIRMED",
