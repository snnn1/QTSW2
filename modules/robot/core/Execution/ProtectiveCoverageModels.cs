...
public sealed class ProtectiveInstrumentState
{
    ...
    /// <summary>Phase 5: Prevents repeated emergency flatten triggers.</summary>
...
public static class ProtectiveAuditPolicy
{
    ...
    /// <summary>Phase 4: Bounded to 1 corrective attempt for first implementation.</summary>
    public const int PROTECTIVE_MAX_CORRECTIVE_ATTEMPTS = 1;
