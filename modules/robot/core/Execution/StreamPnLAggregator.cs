...
public sealed class StreamPnLAggregator
{
    ...
    public StreamPnLSummary GetStreamSummary(string tradingDate, string stream)
    {
        ...
        return new StreamPnLSummary
        {
            ...
            Stream = stream,
            TotalPnLNet = completedTrades.Sum(e => e.RealizedPnLNet),
            TotalPnLGross = completedTrades.Sum(e => e.RealizedPnLGross),
            TotalPnLPoints = completedTrades.Sum(e => e.RealizedPnLPoints),
            ...
            Trades = completedTrades.Select(e => new TradeSummary
            {
                ...
                EntryAvgFillPrice = e.EntryAvgFillPrice,
                ExitAvgFillPrice = e.ExitAvgFillPrice,
                EntryFilledQuantityTotal = e.EntryFilledQuantityTotal,
                ExitFilledQuantityTotal = e.ExitFilledQuantityTotal,
                RealizedPnLNet = e.RealizedPnLNet,
                RealizedPnLGross = e.RealizedPnLGross,
                RealizedPnLPoints = e.RealizedPnLPoints,
    ...
    public DayPnLSummary GetDaySummary(string tradingDate)
    {
        ...
        var streamSummaries = completedTrades
            ...
            .Select(g => new StreamPnLSummary
            {
                TradingDate = tradingDate,
                Stream = g.Key,
                TotalPnLNet = g.Sum(e => e.RealizedPnLNet),
                TotalPnLGross = g.Sum(e => e.RealizedPnLGross),
                TotalPnLPoints = g.Sum(e => e.RealizedPnLPoints),
    ...
    public PortfolioPnLSummary GetPortfolioSummary(DateOnly startDate, DateOnly endDate)
    {
            ...
            .Select(g => new DayPnLSummary
            {
                ...
                StreamSummaries = g.GroupBy(e => e.Stream)
                    .Select(sg => new StreamPnLSummary
                    {
                        TradingDate = g.Key,
                        Stream = sg.Key,
                        TotalPnLNet = sg.Sum(e => e.RealizedPnLNet),
                        TotalPnLGross = sg.Sum(e => e.RealizedPnLGross),
                        TotalPnLPoints = sg.Sum(e => e.RealizedPnLPoints),
        ...
        return new PortfolioPnLSummary
        {
            StartDate = startDate.ToString("yyyy-MM-dd"),
            EndDate = endDate.ToString("yyyy-MM-dd"),
            TotalPnLNet = allEntries.Sum(e => e.RealizedPnLNet),
            TotalPnLGross = allEntries.Sum(e => e.RealizedPnLGross),
            TotalPnLPoints = allEntries.Sum(e => e.RealizedPnLPoints),
