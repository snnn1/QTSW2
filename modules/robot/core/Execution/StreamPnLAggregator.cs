...
public sealed class StreamPnLAggregator
{
    ...
    public StreamPnLSummary GetStreamSummary(string tradingDate, string stream)
    {
        ...
        return new StreamPnLSummary
        {
            ...
            WinCount = completedTrades.Count(e => (e.RealizedPnLNet ?? 0) > 0),
            LossCount = completedTrades.Count(e => (e.RealizedPnLNet ?? 0) < 0),
            BreakEvenCount = completedTrades.Count(e => (e.RealizedPnLNet ?? 0) == 0),
    ...
    public DayPnLSummary GetDaySummary(string tradingDate)
    {
        ...
        var streamSummaries = completedTrades
            ...
            .Select(g => new StreamPnLSummary
            {
                ...
                WinCount = g.Count(e => (e.RealizedPnLNet ?? 0) > 0),
                LossCount = g.Count(e => (e.RealizedPnLNet ?? 0) < 0),
                BreakEvenCount = g.Count(e => (e.RealizedPnLNet ?? 0) == 0),
        ...
        return new DayPnLSummary
        {
            ...
            TotalWinCount = completedTrades.Count(e => (e.RealizedPnLNet ?? 0) > 0),
            TotalLossCount = completedTrades.Count(e => (e.RealizedPnLNet ?? 0) < 0),
            TotalBreakEvenCount = completedTrades.Count(e => (e.RealizedPnLNet ?? 0) == 0),
            TotalSlippageDollars = completedTrades.Sum(e => e.SlippageDollars ?? 0),
            TotalCommission = completedTrades.Sum(e => e.Commission ?? 0),
            TotalFees = completedTrades.Sum(e => e.Fees ?? 0),
    ...
    public PortfolioPnLSummary GetPortfolioSummary(DateOnly startDate, DateOnly endDate)
    {
        ...
        var daySummaries = allEntries
            ...
            .Select(g => new DayPnLSummary
            {
                ...
                TotalWinCount = g.Count(e => (e.RealizedPnLNet ?? 0) > 0),
                TotalLossCount = g.Count(e => (e.RealizedPnLNet ?? 0) < 0),
                TotalBreakEvenCount = g.Count(e => (e.RealizedPnLNet ?? 0) == 0),
                TotalSlippageDollars = g.Sum(e => e.SlippageDollars ?? 0),
                TotalCommission = g.Sum(e => e.Commission ?? 0),
                TotalFees = g.Sum(e => e.Fees ?? 0),
                StreamSummaries = g.GroupBy(e => e.Stream)
                    .Select(sg => new StreamPnLSummary
                    {
                        ...
                        WinCount = sg.Count(e => (e.RealizedPnLNet ?? 0) > 0),
                        LossCount = sg.Count(e => (e.RealizedPnLNet ?? 0) < 0),
                        BreakEvenCount = sg.Count(e => (e.RealizedPnLNet ?? 0) == 0),
        ...
        return new PortfolioPnLSummary
        {
            ...
            TotalWinCount = allEntries.Count(e => (e.RealizedPnLNet ?? 0) > 0),
            TotalLossCount = allEntries.Count(e => (e.RealizedPnLNet ?? 0) < 0),
            TotalBreakEvenCount = allEntries.Count(e => (e.RealizedPnLNet ?? 0) == 0),
