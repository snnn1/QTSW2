...
public static class RobotEventTypes
{
    ...
    private static readonly Dictionary<string, string> _levelMap = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["IEA_ADOPTION_SCAN_NO_PROGRESS_NOT_SKIPPED"] = "INFO",
        ["IEA_ADOPTION_SCAN_MUTATION_TIME_ALIGNED"] = "INFO",
        ["IEA_ADOPTION_SCAN_PHASE_TIMING"] = "INFO",
        ["IEA_VERIFY_REGISTRY_INTEGRITY_DIAG"] = "INFO",
        ["ADOPTION_SAME_STATE_RETRY_WINDOW"] = "WARN",
        ["RECONCILIATION_ASSEMBLE_MISMATCH_DIAG"] = "INFO",

        // IEA adoption / reconciliation hardening
    ...
    private static readonly HashSet<string> _allEvents = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        // Journal
        "JOURNAL_WRITTEN", "EXECUTION_JOURNAL_ERROR", "EXECUTION_JOURNAL_READ_ERROR", "EXECUTION_JOURNAL_CORRUPTION", "EXECUTION_JOURNAL_ADOPTION_INDEX_REBUILT", "EXECUTION_JOURNAL_ADOPTION_INDEX_FALLBACK", "EXECUTION_JOURNAL_ADOPTION_INDEX_REBUILD_FAILED", "EXECUTION_SLIPPAGE_DETECTED",
