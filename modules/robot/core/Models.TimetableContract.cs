...
public sealed class TimetableContract
{
    ...
    /// <summary>CME session trading date (canonical JSON field).</summary>
    ...
    /// <summary>Content-hash and non-execution utilities only (legacy trading_date fallback).</summary>
