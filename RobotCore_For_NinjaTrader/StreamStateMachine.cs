...
public sealed class StreamStateMachine
{
    ...
    private string? _triggerReason; // "ENTRY_STOP_BRACKET_LONG", "ENTRY_STOP_BRACKET_SHORT", "NO_TRADE_MARKET_CLOSE"
    ...
    /// <summary>
    /// <summary>
    /// SIMPLIFICATION: Consolidate all precondition checks for stop bracket submission.
    /// Returns result indicating whether brackets can be submitted and reason if not.
    /// </summary>
    private (bool CanSubmit, string Reason, object? Details) CanSubmitStopBrackets(DateTimeOffset utcNow)
    {
        ...
        {
            return (false, "NULL_DEPENDENCIES", new 
            { 
        ...
        // Consolidate breakout level checks (removes duplicate check)
        if (!_brkLongRounded.HasValue || !_brkShortRounded.HasValue)
        {
            return (false, "BREAKOUT_LEVELS_MISSING", new 
            { 
        ...
        {
            return (false, "RANGE_VALUES_MISSING", new 
            { 
