...
public class HealthMonitorConfig
{
    ...
    /// <summary>
    /// Built-in per-instrument stall thresholds (quant-grade). Used when instrument_stall_threshold_seconds has no entry.
    /// Config values override these when present.
    /// </summary>
    ...
    /// <summary>
    /// Get effective stall threshold (seconds) for an instrument.
    /// Priority: config instrument_stall_threshold_seconds → built-in defaults → default_stall_seconds → data_stall_seconds.
    /// </summary>
