...
public static class RobotEventTypes
{
    ...
    private static readonly HashSet<string> _allEvents = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "ENGINE_TICK_STALL_DETECTED", "ENGINE_TICK_STALL_STARTUP", "ENGINE_TICK_STALL_RUNTIME", "ENGINE_TICK_STALL_RECOVERED",
        ...
        // Slot persistence
        "FORCED_FLATTEN_MARKET_CLOSE", "FORCED_FLATTEN_TRIGGERED", "SESSION_CLOSE_RESOLVED", "SESSION_CLOSE_RESOLUTION_SUCCESS", "SESSION_CLOSE_RESOLUTION_FAILURE", "SESSION_CLOSE_HOLIDAY",
