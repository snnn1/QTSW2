...
public static class RobotEventTypes
{
    ...
    private static readonly Dictionary<string, string> _levelMap = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["EXECUTION_UPDATE_SKIPPED_WRONG_INSTANCE"] = "INFO",
        ...
        ["BE_SKIP_STOP_ALREADY_TIGHTER"] = "INFO",
    ...
    {
        // Engine lifecycle
        "ENGINE_START", "ROBOT_BUILD_SIGNATURE", "ENGINE_STOP", "ENGINE_STAND_DOWN", "ENGINE_TICK_INVALID_STATE",
        ...
        "EXECUTION_UPDATE_SKIPPED_WRONG_INSTANCE",
        ...
        "STOP_MODIFY_ATTEMPT", "STOP_MODIFY_SUCCESS", "STOP_MODIFY_FAIL", "STOP_MODIFY_SKIPPED", "BE_SKIP_STOP_ALREADY_TIGHTER",
        ...
        // Reconciliation
        "TRADE_RECONCILED", "RECONCILIATION_SKIPPED_HAS_WORKING_ORDERS", "RECONCILIATION_PASS_SUMMARY", "RECONCILIATION_QTY_MISMATCH",
