...
public static class RobotEventTypes
{
    ...
    private static readonly HashSet<string> _allEvents = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "ENGINE_TICK_STALL_DETECTED", "ENGINE_TICK_STALL_STARTUP", "ENGINE_TICK_STALL_RUNTIME", "ENGINE_TICK_STALL_RECOVERED", "ENGINE_TICK_CALLSITE",
        ...
        "BE_PROTECTION_STATE_CHANGED", "BE_PROTECTION_STATE_PRUNED", "PROTECTION_ENQUEUED_BACKLOG_WARN", "PROTECTION_ENQUEUED_BACKLOG_TIMEOUT", "BE_STOP_NOT_VISIBLE_PROTECTION_PENDING", "BE_STOP_VISIBILITY_TIMEOUT",
        "BE_TRIGGER_REACHED", "BE_TRIGGER_RETRY_NEEDED", "BE_TRIGGER_FAILED", "BE_TRIGGER_TIMEOUT_ERROR",
