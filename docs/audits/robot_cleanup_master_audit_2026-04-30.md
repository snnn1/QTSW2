...
9. Next: checkpoint this cleanup batch, use `docs/audits/mismatch_authority_next_level_map_2026-05-01.md` to split authority simplification into read-only proof, then one narrow behavior change at a time.
