...
public sealed class MismatchEscalationCoordinator
{
    ...
    /// <summary>Internal coordinator flag — enforcement must use engine EPA authority via <c>onMismatchExecutionBlockAuthorityChanged</c>, not this method on hot paths.</summary>
    ...
    private void PublishMismatchExecutionBlockAuthorityIfChanged(string inst, MismatchInstrumentState state, bool wasBlocked, DateTimeOffset utcNow)
    {
