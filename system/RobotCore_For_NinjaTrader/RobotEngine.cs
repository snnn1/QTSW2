...
public sealed class RobotEngine : IExecutionRecoveryGuard
{
    ...
    public void Start()
    {
        ...
        lock (_engineLock)
        {
            ...
            _riskGate = new RiskGate(_spec, _time, _log, _killSwitch, guard: this,
                ...
                isInstrumentFrozen: IsInstrumentFrozenSupervisoryProtectiveOnly);
            ...
            if (_executionAdapter is NinjaTraderSimAdapter simAdapter)
            {
                ...
                simAdapter.SetEngineCallbacks(
                    ...
                    isMismatchExecutionBlocked: IsMismatchExecutionAuthorityBlocked,
                    isInstrumentFrozenOrEpaBlocked: IsInstrumentFrozenSupervisoryProtectiveOnly);
    ...
    /// <summary>
    /// RiskGate gate −1b / EPA frozen path: frozen latch, protective, IEA supervisory — excludes mismatch authority (gate −1a).
    /// </summary>
    private bool IsInstrumentFrozenSupervisoryProtectiveOnly(string instrument)
    {
    ...
    /// <summary>
    /// Phase 5: Combined block for adapters / reentry — mismatch execution authority (G1) OR frozen/supervisory/protective.
    /// </summary>
    private bool IsInstrumentFrozenOrSupervisorilyBlocked(string instrument)
    {
        return IsMismatchExecutionAuthorityBlocked(instrument) || IsInstrumentFrozenSupervisoryProtectiveOnly(instrument);
    }
