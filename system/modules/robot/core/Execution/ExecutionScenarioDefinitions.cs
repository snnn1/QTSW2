...
public static class ExecutionScenarioDefinitions
{
    ...
    /// <summary>
    /// First six scenarios (normal ordering + early stress): entry/target, deferred execution, dedup,
    /// stop-cancel recovery, stop-cancel flatten, persistent mismatch. Distinct from <see cref="GetChaosScenarios"/>.
    /// </summary>
    public static IReadOnlyList<ScenarioDefinition> GetFirstSix()
    {
        var all = GetAll();
        return new[]
        {
