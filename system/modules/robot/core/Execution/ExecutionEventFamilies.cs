...
public static class ExecutionEventTypes
{
    ...
    /// <summary>Phase 4A: Stop not yet Working/Accepted in snapshot during bounded post-fill alignment window.</summary>
    ...
    /// <summary>Phase 4B: Mismatch present but first gate engagement deferred during Tier-1 PendingAlignment window.</summary>
...
{
    private static readonly Dictionary<string, ExecutionEventFamily> _typeToFamily = new(StringComparer.OrdinalIgnoreCase)
    {
