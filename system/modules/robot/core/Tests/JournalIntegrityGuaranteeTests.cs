...
public static class JournalIntegrityGuaranteeTests
{
    ...
    private static string? Case_RecoveredSupersededBy_RealStrategyMatchesBroker()
    {
        ...
        var jdir = RobotRunArtifactPaths.StateExecutionJournals(tmp.ProjectRoot);
    ...
    private static string? Case_RecoveredSupersededBy_NoClose_OnlyRecovered()
    {
        ...
        var json = File.ReadAllText(Path.Combine(RobotRunArtifactPaths.StateExecutionJournals(tmp.ProjectRoot),
    ...
    {
        var jdir = RobotRunArtifactPaths.StateExecutionJournals(projectRoot);
    ...
    private sealed class TempJournal : IDisposable
    {
        ...
        /// <summary>Temp project root (contains state/execution_journals).</summary>
