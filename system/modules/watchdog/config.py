...
# Repo root: .../system/modules/watchdog/config.py -> parents[3]
...
LIVE_CRITICAL_EVENT_TYPES = {
    ...
    "CONNECTION_RECOVERY_RESOLVED",  # Legacy JSONL name; robot should emit DISCONNECT_RECOVERY_COMPLETE
    ...
    "PROTECTIVES_PLACED",  # Proof log with intent_id in data; fallback if SUBMITTED ingest missed
    "PROTECTIVE_ORDERS_FAILED_FLATTENED",
    # Intent Exposure
    "INTENT_EXPOSURE_REGISTERED",
    "INTENT_EXPOSURE_CLOSED",
    "INTENT_EXIT_FILL",
    "TRADE_COMPLETED",  # StreamStateMachine terminal; feed visibility for injects and completed trades
    ...
    "SESSION_REENTRY_ATTEMPT",
    "SESSION_REENTRY_BLOCKED",
    "SESSION_REENTRY_EXECUTED",
    "REENTRY_FAILED",
    "REENTRY_PROTECTION_FAILED",
    "EXECUTION_JOURNAL_CORRUPTION",
    "EXECUTION_JOURNAL_ERROR",
    # State consistency / reconciliation gate (ingest + incidents; execution blocked while engaged)
