...
/** Engine summary.json (read-through GET /api/watchdog/run-summary). */
...
export type RunSummaryResult = EngineRunSummary | RunSummaryUnavailable;

export function isRunSummaryUnavailable(r: RunSummaryResult): r is RunSummaryUnavailable {
  return (r as RunSummaryUnavailable).available === false;
}

/** KEY_EVENTS.jsonl line (engine KeyEventWriter schema). */
