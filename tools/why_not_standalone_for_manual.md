# Why Manual Runs Can't Just Use the Standalone Script
...
### Option 1: ALWAYS run pipeline as separate process
...
### Option 2: SHARED ORCHESTRATOR SERVICE
...
### Option 3: CURRENT APPROACH (BEST)
